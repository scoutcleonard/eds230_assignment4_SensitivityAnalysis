...
The estimated atmospheric conductance for this forest is `r round(part_2_answer, 2)` Siemens per centimeter.

# Part 3

Do a sensitivity analysis that considers the sensitivity of your estimate to uncertainty in the following parameters and inputs:
...
Generate parameter values for the 4 parameters:
```{r}
...
Run atmospheric conductance model with parameters:
